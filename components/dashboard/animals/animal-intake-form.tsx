...
//   FormMessage,
// } from "@/components/ui/form";
// import { AnimalListingStatus, IntakeType } from "@prisma/client";
// import {
//   animalHealthStatusOptions,
//   animalListingStatusOptions,
//   animalSexOptions,
...
//   // Dynamically generate the list of available status options.
//   const availableStatusOptions = useMemo(() => {
//     // For a NEW animal, only allow Draft or Published.
//     if (!isEditMode) {
//       return animalListingStatusOptions.filter(
//         (opt) =>
//           opt.value === AnimalListingStatus.DRAFT ||
...
//       );
//     }
//     // For an EXISTING animal with a locked status, show only that status.
//     if (isStatusLocked) {
//       return animalListingStatusOptions.filter(
//         (opt) => opt.value === animal.listingStatus
//       );
//     }
//     // For an unlocked EXISTING animal, allow changing between Draft and Published.
//     return animalListingStatusOptions.filter(
//       (opt) =>
//         opt.value === AnimalListingStatus.DRAFT ||
//         opt.value === AnimalListingStatus.PUBLISHED
...
//   useEffect(() => {
//     if (animal?.adoptionApplications) {
//       const hasApproved = animal.adoptionApplications.some(
