...
const livingSituationOptions = {
  [LivingSituation.OWN_HOME]: "Own Home",
  [LivingSituation.RENT_APARTMENT]: "Rent Apartment",
  [LivingSituation.RENT_HOUSE]: "Rent House",
  [LivingSituation.LIVE_WITH_FAMILY]: "Live with Family",
...
export function MyApplicationForm({
  ...
  const form = useForm<MyApplicationFormData>({
    // The resolver now uses the simplified schema without type conflicts
  ...
  // The submit handler is simple because the form data is already string-based
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <Card>
        <CardHeader>
          <CardTitle>You are applying for: {animal.name}</CardTitle>
          <CardDescription>
            Please complete the form below to submit your adoption application.
            ...
            <CardContent className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          {Object.entries(livingSituationOptions).map(
                            ([value, label]) => (
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <div className="text-sm font-medium">Do you have a yard? *</div>
                      <FormControl>
                        <RadioGroup
                          onValueChange={field.onChange}
                          value={field.value}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <div className="text-sm font-medium">Are there children in the home? *</div>
                      <FormControl>
                        <RadioGroup
                          onValueChange={field.onChange}
                          value={field.value}
